...
CREATE TABLE `cars` (
  ...
  `DailyPrice` decimal(25,0) NOT NULL,
  `Description` longtext NOT NULL,
  `FindexScore` varchar(45) NOT NULL,
  PRIMARY KEY (`Id`,`ColorId`,`BrandId`),
  UNIQUE KEY `Id_UNIQUE` (`Id`),
  KEY `BrandId_idx` (`BrandId`),
  KEY `ColorId_idx` (`ColorId`),
  CONSTRAINT `BrandId` FOREIGN KEY (`BrandId`) REFERENCES `brands` (`Id`),
  CONSTRAINT `ColorId` FOREIGN KEY (`ColorId`) REFERENCES `colors` (`Id`)
